...
//       const email = req.query.email;
//       const result = await slotCollection.findOne({ docEmail: email });
//       res.send(result);
//     });
...
//       };
//       const option = { upsert: true };
//       await appointmentOptionCollection.findOneAndUpdate(
//         filter,
//         updateDoc,
//         option
//       );
...
//       const zu = await appointmentOptionCollection.findOne({
//         name: tz.specialty,
//       });
...
//           },
//         };
//         const zu = await slotCollection.findOneAndUpdate(
//           filter,
//           updateDoc,
//           options
//         );
